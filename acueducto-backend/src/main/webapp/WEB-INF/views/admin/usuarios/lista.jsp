...
<script>document.getElementById('pageTitle').textContent = 'Usuarios';</script>
<script>document.getElementById('nav-usuarios').classList.add('active');</script>
...
<div class="table-container fade-in-item">
    ...
    <div class="table-header">
        <div class="d-flex align-items-center gap-3 flex-grow-1 flex-wrap">
            <h5><i class="bi bi-people me-2"></i>Listado de Usuarios</h5>
            <form id="searchForm" action="<s:url namespace='/admin' action='usuarios'/>" method="get" class="d-flex gap-2 ms-auto flex-wrap">
                <div class="search-box">
                    <i class="bi bi-search search-icon"></i>
                    <input type="text" id="searchInput" name="q" value="<s:property value='q'/>" class="form-control"
                           placeholder="Buscar por nombre..." style="width:240px;"/>
                </div>
        ...
        <a href="<s:url namespace='/admin' action='usuario-formulario'/>" class="btn btn-primary btn-sm">
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tbody>
                <s:if test="usuarios != null && usuarios.size() > 0">
                        ...
                        <tr class="fade-in-item">
                            ...
                            <td>
                                <span class="text-muted">
                                    <i class="bi bi-calendar3 me-1"></i><s:property value="fechaInsert"/>
                                </span>
                            </td>
                            <td>
                                <s:if test="activo">
                            ...
                            <td class="text-center">
                                <div class="d-flex gap-1 justify-content-center">
                                    ...
                                    <s:if test="activo">
                                        <a href="<s:url namespace='/admin' action='usuario-desactivar'>
                                                    <s:param name='id' value='id'/>
                                                 </s:url>"
                                           class="btn-action btn-action-deactivate"
                                           title="Desactivar"
                                           data-confirm="deactivate"
                                           data-name="<s:property value='nombre'/> <s:property value='apellidos'/>">
                                            <i class="bi bi-toggle-off"></i>
                                        </a>
                                    </s:if>
                                    <a href="<s:url namespace='/admin' action='usuario-eliminar'>
                                                <s:param name='id' value='id'/>
                                             </s:url>"
                ...
                <nav>
                    <ul class="pagination pagination-sm mb-0">
                        <s:if test="page > 0">
                            <li class="page-item">
                                <a class="page-link"
                                   href="<s:url namespace='/admin' action='usuarios'>
